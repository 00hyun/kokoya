...
JDBCUtil jdbc = JDBCUtil.getInstance();
	...
	public List<Map<String, Object>> list() {
		return jdbc.selectList("SELECT * FROM ANIMALGRAM ORDER BY ANI_NUM ASC");
	}
	...
	public List<Map<String, Object>> friendList() {
		return jdbc.selectList("SELECT * FROM FRIEND");
	}
	...
	public List<Map<String, Object>> re_list(List<Object> param) {
		
		String str = "SELECT * FROM REPLY WHERE ANI_NUM =? ";
	...
	public List<Map<String, Object>> friendlist() {
		...
		String sql = "SELECT * FROM ANIMALGRAM A, FRIEND B WHERE A.MEM_ID = B.FRIEND_ID ORDER BY A.ANI_NUM ASC}";
