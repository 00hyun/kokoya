...
public class Controller {
	...
	AdminService admonService = AdminService.getInstance();
	...
	private void start() {
		...
		while(true) {		
			...
			// 관리자
			case View.ADMIN: view = admonService.adminPage(); break;
			case View.ADMIN_ANIGRAM: view = admonService.adminAnimalgram(); break;
			...
			case View.ANI_MYDELETE: view = anigramService.deleteAni(); break;
